...
This example demonstrates Wallet-Relying Party Registration Certificates (WRPRC).
...
| Parameter | Type       | Value | Description | Reference |
|-----------|------------|-------|-------------|-----------|
| `typ`     | *string*   |   `rc-wrp+jwt`   | Registration Certificate for WRP in JWT format | ETSI TS 119 475 Table 5 |
| `alg`     | *string*   |   Allowed algorithm   | Signing algorithm | ETSI TS 119 182-1 clause 5.1.2; ETSI TS 119 475 GEN-5.2.1-04 |
| `b64`     | *string*   |   `true`    | Base64 encoding indicator | ETSI TS 119 182-1 clause 5.1.2; ETSI TS 119 475 Table 5 |
| `cty`     | *[string]* |   `["b64"]`    | Content type | ETSI TS 119 182-1 clause 5.1.3; ETSI TS 119 475 Table 5 |
| `x5c`     | *[string]* |   Certificate chain    | Certificate chain for verification | ETSI TS 119 182-1 clause 5.1.8; ETSI TS 119 475 Table 5 |
