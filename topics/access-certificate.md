...
| :-------: | :--------: | :------: | :---------: | :----- | :---------- |
| `authorityKeyIdentifier` | ETSI EN 319 412-2 clause 4.3.1 | REQUIRED | Non-critical | *SEQUENCE* | Extension with the OID `2.5.29.35`.<br><br>Key identifier for the issuing CA's public key.<br><br>Contains: `keyIdentifier` (*OCTET STRING*), `authorityCertIssuer` (*GeneralNames*), and `authorityCertSerialNumber` (*INTEGER*). |
