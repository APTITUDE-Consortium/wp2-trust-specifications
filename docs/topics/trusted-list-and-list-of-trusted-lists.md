...
!!! choice "APTITUDE Implementation Choices"
    ...
    For the pilot-specific <roles:Provider of Qualified Electronic Attestation of Attributes (QEAA Provider)|QEAA Provider> and <roles:Provider of Electronic Attestation of Attributes (EAA Provider)|EAA Provider> lists, `ServiceTypeIdentifier` SHALL respectively use `http://aptitude-consortium.github.io/SvcType/{Specific_attestation}/Issuance`, `http://aptitude-consortium.github.io/SvcType/{Specific_attestation}/Revocation` as applicable.
