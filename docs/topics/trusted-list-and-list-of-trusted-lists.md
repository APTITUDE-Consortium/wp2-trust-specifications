...
1. Qualified preservation for <artifacts:Qualified Electronic Signature (QES)|Qualified Electronic Signatures> and/or qualified electronic seals
1. Qualified validation of <artifacts:Qualified Electronic Signature (QES)|Qualified Electronic Signatures> and/or qualified electronic seals
1. Remote <artifacts:Qualified Electronic Signature (QES)|Qualified Electronic Signatures> creation device, also known as "remote signing"
1. Remote qualified <artifacts:Electronic Seal> creation device, also known as "remote sealing"
...
1. Not qualified electronic attestation of attributes issued by or on behalf of a <roles:Public Sector Body> responsible for an <components:Authentic Source> (usually referred to as <credentials:Public Electronic Attestation of Attributes (PuB-EAA)|PuB-EAA>)
