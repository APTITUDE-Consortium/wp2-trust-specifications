...
| `issuerUniqueID`            | `BIT STRING`    | OPTIONAL      | Represents the issuer unique identifiers, to handle the possibility of reuse of issuer names over time. It SHOULD NOT be present. | Section 4.1.2.8 |
| `subjectUniqueID`           | `BIT STRING`    | OPTIONAL      | Represents the subject unique identifiers, to handle the possibility of reuse of subject names over time. It SHOULD NOT be present. | Section 4.1.2.8 |
