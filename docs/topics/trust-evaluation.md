...
2. [**Sign/Seal Validation Process**](../sections/trust-evaluation-process.md#signseal-validation-process);
3. [**Authentication Process**](../sections/trust-evaluation-process.md#authentication-process);
4. [**Authorization Process**](../sections/trust-evaluation-process.md#authorization-process).

The [**X.509 Certificate Chain Validation**](../sections/trust-evaluation-process.md#certificate-path-validation) algorithm is shared by the Sign/Seal Validation Process, the Authentication Process, and the Authorization Process. It validates a certificate path against the <artifacts:Trust Anchor> obtained from a validated <artifacts:List of Trusted Entities (LoTE)|LoTE> or <artifacts:Trusted List (TL)|Trusted List>.
