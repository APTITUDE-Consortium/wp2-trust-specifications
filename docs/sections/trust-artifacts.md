...
| <protocols:Online Certificate Status Protocol (OCSP)> Artifacts   | Provider of WRPAC and Sign/Seal Certificates | Component of the <roles:Certificate Authority (CA)\|Certificate Authority> managed by APTITUDE WP2 | [APTITUDE Online Certificate Status Protocol Artifacts Profile](#online-certificate-status-protocol-artifacts) |
