This section introduces the trust artifacts used within the APTITUDE ecosystem. The trust artifacts defined herein are consumed by the [Trust Evaluation Processes](../sections/trust-evaluation-process.md) and are produced and managed by the [APTITUDE Trust Architecture](../sections/trust-architecture.md) components.

!!! note

    In this document, the term *trust artifact* refers to a structured data object exchanged or consulted during trust evaluation. Trust artifacts are distinct from the credentials (PIDs, PuB-EAAs, EAAs, QEAAs) whose authenticity they help verify.

The table below lists the trust artifacts defined in this document, along with their responsible actors in EUDIW and APTITUDE, and the corresponding reference:

| Artifact                                                          | Responsible Actor(s) in EUDIW     | Responsible Actor(s) in APTITUDE                  | Reference |
| ----------------------------------------------------------------- | --------------------------------- | ------------------------------------------------- | --------- |
| <artifacts:Certificate Revocation List (CRL)>                     | Provider of WRPAC and Sign/Seal Certificates | Component of the Certification Authority managed by APTITUDE WP2 | [APTITUDE Certificate Revocation List Profile](#certificate-revocation-list) |
...
| Sign/Seal Certificate                                             | Provider of Sign/Seal Certificates | Certification Authority managed by APTITUDE WP2 | [APTITUDE Entity Sign/Seal Certificate Profile](#entity-signseal-certificate) |
| Status List Token                                                 | Provider of WRPRC | Component of the Certification Authority managed by APTITUDE WP2 | [APTITUDE Status List Token Profile](#status-list-token) |
